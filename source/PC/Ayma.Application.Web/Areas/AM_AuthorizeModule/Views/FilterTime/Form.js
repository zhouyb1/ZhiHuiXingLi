...
var bootstrap = function ($, ayma) {
    ...
    var page = {
        ...
        initData: function () {
            $.SetForm(top.$.rootUrl + '/AM_AuthorizeModule/FilterTime/GetFormData?keyValue=' + objectId, function (data) {
                var formdata = data || {};
    ...
    acceptClick = function () {
        ...
        $.SaveForm(top.$.rootUrl + '/AM_AuthorizeModule/FilterTime/SaveForm', postData, function (res) { });
