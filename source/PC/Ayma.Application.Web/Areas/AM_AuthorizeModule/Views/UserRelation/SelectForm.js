...
var bootstrap = function ($, ayma) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            // 公司
            $('#company_select').CompanySelect({ isLocal: true }).bind('change', function () {
    ...
    acceptClick = function () {
        $.SaveForm(top.$.rootUrl + '/AM_AuthorizeModule/UserRelation/SaveForm', { objectId: objectId, category: category, userIds: String(userlistselected) }, function (res) { });
        return true;
    };
    page.init();
}