...
var bootstrap = function ($, ayma) {
    ...
    var page = {
        ...
        bind: function () {
            //新闻栏目
            $('#F_CategoryId').DataItemSelect({ code: 'NewsCategory', maxHeight: 230 });
            //内容编辑器
        ...
        initData: function () {
            if (!!selectedRow) {
                ...
                $.SetForm(top.$.rootUrl + '/AM_OAModule/News/GetEntity?keyValue=' + keyValue, function (data) {
                    setTimeout(function () {
    ...
    acceptClick = function (callBack) {
        ...
        $.SaveForm(top.$.rootUrl + '/AM_OAModule/News/SaveForm?keyValue=' + keyValue, postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack();
            }
