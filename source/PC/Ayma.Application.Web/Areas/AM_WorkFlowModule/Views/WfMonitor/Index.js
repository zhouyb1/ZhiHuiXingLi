...
var bootstrap = function ($, ayma) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#am_eye').on('click', function () {
                ...
                if (ayma.checkrow(processId)) {
                    ayma.frameTab.open({ F_ModuleId: "eye" + processId, F_Icon: 'fa magic', F_FullName: '查看流程进度【' + processName + '】', F_UrlAddress: '/AM_WorkFlowModule/WfMyTask/CustmerWorkFlowForm?tabIframeId=' + "eye" + processId + '&type=100' + "&processId=" + processId });
                }
            });
        },
        initleft: function () {
        ...
        initGird: function () {
            $('#girdtable').jfGrid({
                url: top.$.rootUrl + '/AM_WorkFlowModule/WfMonitor/GetPorcessList',
                headData: [
