...
var bootstrap = function ($, ayma) {
    ...
    var flow = {
        release: function (isNew) { // 发起流程方法
            ...
            ayma.layerForm({
                id: 'ReleaseFlowForm',
                title: '发起流程',
                url: top.$.rootUrl + '/AM_WorkFlowModule/WfMyTask/ReleaseFlowForm',
                width: 600,
                height: 400,
                                    ...
                                    ayma.workflowapi.create({
                                        ...
                                        callback: function (res, data) {
                                            if (res) {
                                                ...
                                                ayma.frameTab.close(tabIframeId);
                                            }                                            
                                        }
                                    });
                                }
                                else {
                                    ayma.alert.error('表单数据保存失败');
                                }
                            }
                            else {
                                setTimeout(function () {
        ...
        audit: function () { // 审核流程
            ...
            ayma.layerForm({
                id: 'AuditFlowForm',
                title: '审核流程',
                url: top.$.rootUrl + '/AM_WorkFlowModule/WfMyTask/AuditFlowForm',
                width: 600,
                height: 400,
                callBack: function (id) {
                    return top[id].acceptClick(function (formData, auditers) {
        ...
        sign: function () { // 加签流程
            ayma.layerForm({
                id: 'AuditFlowForm',
                title: '加签审核',
                url: top.$.rootUrl + '/AM_WorkFlowModule/WfMyTask/SignFlowForm',
                width: 600,
                height: 400,
                callBack: function (id) {
    ...
    var page = {
        ...
        bind: function () {
            // 显示信息选项卡
            $('#tablist').FormTabEx(function (id) {
                if (id == 'workflowshcemeinfo') {
                    $("#flow").children(".am-workflow-work").mCustomScrollbar("scrollTo", [0, 0], {
                        scrollInertia: 0
                    });
                    $('#print').hide();
                }
                ...
                openNode: function (node) {
                    ...
                    if (!!node.history) {
                        ayma.layerForm({
                            ...
                            url: top.$.rootUrl + '/AM_WorkFlowModule/WfMyTask/WfNodeForm',
                            width: 600,
                            height: 400,
                            btn: null
                        });
            ...
            $('#print').on('click', function () {
                ...
                var $iframe = ayma.iframe(iframeId, frames);
                $iframe.$('.am-form-wrap:visible').jqprint();
            });
            $('#print').show();
        },
        // 初始化流程信息
        ...
        iframeLoad: function (iframeId, url, callback, i) {
            ...
            var _iframeLoaded = function () {
                var iframeObj = ayma.iframe(iframeId, frames);
    ...
    function initScheme() {
        ...
        $('#flow').workflowSet('set', { data: flowScheme });
    }
