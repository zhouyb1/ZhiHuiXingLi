            ...
            $('#formId').select({
                ...
                select: function (item) {
                    if (!!item) {
                        ...
                        var url = '/AM_FormModule/Custmerform/WorkflowInstanceForm?id=' + item.F_Id;
                        $('#name').val(formName);
                        $('#url').val(url);
                        $.SetForm(top.$.rootUrl + '/AM_FormModule/Custmerform/GetFormData?keyValue=' + item.F_Id, function (data) {
                            ...
                            $('#field').selectRefresh({ data: fields });
                        });
                    }
                    else {
                        $('#field').selectRefresh({ data: [] });
                    }
                }
            });
