...
namespace Ayma.Application.Web.Areas.AM_FormModule.Controllers
{
    /// <summary>
    /// 创建人：框架开发组
    /// 日 期：2017.04.01
    ...
    public class FormRelationController : MvcControllerBase
    {
        ...
        public ActionResult SaveForm(string keyValue, string relationJson, string moduleJson, string moduleColumnJson)
        {
            ...
            if (string.IsNullOrEmpty(keyValue))// 新增
            {
                ...
                moduleEntity.F_UrlAddress = "/AM_FormModule/FormRelation/PreviewIndex?id=" + formRelationEntity.F_Id;
            }
            ...
            addButtonEntity.F_EnCode = "am_add";
            ...
            editButtonEntity.F_EnCode = "am_edit";
            ...
            deleteButtonEntity.F_EnCode = "am_delete";
            ...
            moduleIBLL.SaveEntity(formRelationEntity.F_ModuleId, moduleEntity, moduleButtonList, moduleColumnList,"0");
