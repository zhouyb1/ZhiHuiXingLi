...
var bootstrap = function ($, ayma) {
    ...
    var page = {
            ...
            $('#wizard').wizard().on('change', function (e, data) {
                ...
                if (data.direction == "next") {
                    if (data.step == 1) {
                        ...
                        var formData = $('#step-2').GetFormData();
                        ...
                        ayma.httpAsyncPost(top.$.rootUrl + '/AM_CodeGeneratorModule/TemplatePC/LookFastCode', postData, function (res) {
                            if (res.code == 200)
                            {
        ...
        /*保存数据*/
        save: function () {
            var moduleData = $('#step-4').GetFormData();
            moduleData.F_EnabledMark = 1;
            postData.moduleEntityJson = JSON.stringify(moduleData);
            $.SaveForm(top.$.rootUrl + '/AM_CodeGeneratorModule/TemplatePC/CreateFastCode', postData, function (res) {
