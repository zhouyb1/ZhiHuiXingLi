...
var bootstrap = function ($, ayma) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            // 固定信息类型
            $('#fixedInfoType').select({ placeholder: false }).selectSet('guid');
            // 是否隐藏
            $('#fixedInfoHide').select({ placeholder: false }).selectSet('1');
            ...
            $('#am_edit_datasource').on('click', function () {
                ...
                if (ayma.checkrow(_name)) {
                    ayma.layerForm({
                        ...
                        title: '设置选择字段',
                        url: top.$.rootUrl + '/AM_CodeGeneratorModule/TemplatePC/GridSelectFieldForm',
                        width: 450,
                        height: 400,
