...
var bootstrap = function ($, ayma) {
    ...
    var page = {
            ...
            $('#wizard').wizard().on('change', function (e, data) {
                ...
                if (data.direction == "next") {
                    if (data.step == 1) {
                        ...
                        ayma.httpAsyncPost(top.$.rootUrl + '/AM_CodeGeneratorModule/TemplatePC/LookCustmerCode', postData, function (res) {
                            if (res.code == 200) {
        ...
        save: function () {
            ...
            $.SaveForm(top.$.rootUrl + '/AM_CodeGeneratorModule/TemplatePC/CreateCustmerCode', postData, function (res) { }, true);
        }
    };
