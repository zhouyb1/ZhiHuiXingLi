...
var bootstrap = function ($, ayma) {
    ...
    var page = {
            ...
            $('#wizard').wizard().on('change', function (e, data) {
                ...
                if (data.direction == "next") {
                    if (data.step == 1) {
                        ...
                        ayma.httpAsyncPost(top.$.rootUrl + '/AM_CodeGeneratorModule/TemplatePC/LookEntityCode', postData, function (res) {
                            if (res.code == 200) {
        ...
        /*保存数据*/
        save: function () {
            $.SaveForm(top.$.rootUrl + '/AM_CodeGeneratorModule/TemplatePC/CreateEntityCode', postData, function (res) { });
        }
    };
