    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#am_add').on('click', function () {
                ...
                ayma.layerForm({
                    id: 'Form',
                    title: '添加快速导入',
                    url: top.$.rootUrl + '/AM_SystemModule/ExcelImport/Form?moduleId=' + moduleId,
                    width: 1100,
                    height: 700,
                    maxmin: true,
            ...
            $('#am_edit').on('click', function () {
                ...
                if (ayma.checkrow(keyValue)) {
                    ayma.layerForm({
                        id: 'Form',
                        title: '编辑快速导入',
                        url: top.$.rootUrl + '/AM_SystemModule/ExcelImport/Form?keyValue=' + keyValue,
                        width: 1100,
                        height: 700,
                        maxmin: true,
                        callBack: function (id) {
            ...
            $('#am_delete').on('click', function () {
                ...
                if (ayma.checkrow(keyValue)) {
                    ayma.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            ayma.deleteForm(top.$.rootUrl + '/AM_SystemModule/ExcelImport/DeleteForm', { keyValue: keyValue }, function () {
                                refreshGirdData();
                            });
                        }
                    });
            ...
            $('#am_enable').on('click', function () {
                ...
                if (ayma.checkrow(keyValue)) {
                    ayma.layerConfirm('是否确认要【启用】！', function (res) {
                        if (res) {
                            ayma.postForm(top.$.rootUrl + '/AM_SystemModule/ExcelImport/UpdateForm?keyValue=' + keyValue, { F_EnabledMark: 1 }, function () {
                                refreshGirdData();
                            });
                        }
                    });
            ...
            $('#am_disable').on('click', function () {
                ...
                if (ayma.checkrow(keyValue)) {
                    ayma.layerConfirm('是否确认要【停用】！', function (res) {
                        if (res) {
                            ayma.postForm(top.$.rootUrl + '/AM_SystemModule/ExcelImport/UpdateForm?keyValue=' + keyValue, { F_EnabledMark: 0 }, function () {
                                refreshGirdData();
                            });
                        }
                    });
        ...
        initGird: function () {
            $('#girdtable').AuthorizeJfGrid({
                url: top.$.rootUrl + '/AM_SystemModule/ExcelImport/GetPageList',
                headData: [
