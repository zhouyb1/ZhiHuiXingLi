...
namespace Ayma.Application.Web.Areas.AM_SystemModule.Controllers
{
    /// <summary>
    /// 创建人：框架开发组
    /// 日 期：2017.03.09
    ...
    public class ModuleController : MvcControllerBase
    {
        ...
        [AjaxOnly]
        public ActionResult SaveForm(string keyValue, string moduleEntityJson, string moduleButtonListJson, string moduleColumnListJson,string type="0")
        {
            ...
            if (type == "1")
            {
                moduleIBLL.SaveEntity("", moduleEntity, moduleButtonList, moduleColumnList, type);
            }
            else
            {
                moduleIBLL.SaveEntity(keyValue, moduleEntity, moduleButtonList, moduleColumnList,"0");
            }
            return Success("保存成功。");
        }
        /// <summary>
