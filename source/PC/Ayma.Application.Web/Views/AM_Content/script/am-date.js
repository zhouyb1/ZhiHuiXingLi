...
(function ($, ayma) {
    ...
    $.extend(ayma, {
        ...
        getDate: function (format, strInterval, Number) {
            ...
            var res = ayma.formatDate(myDate, format);
            return res;
        },
        // 月
        getMonth:function(){
            ...
            var currentDate = ayma.parseDate(ayma.formatDate(new Date(), "yyyy-MM-01"));
            var endDate = currentDate.DateAdd('m', 1).DateAdd('d', -1);

            res.begin = ayma.formatDate(currentDate, 'yyyy-MM-dd 00:00:00');
            res.end = ayma.formatDate(endDate, 'yyyy-MM-dd 23:59:59');
        ...
        getPreMonth: function () {
            ...
            res.begin = ayma.formatDate(preMonth, 'yyyy-MM-01 00:00:00');
            res.end = ayma.formatDate(preMonth, 'yyyy-MM-dd 23:59:59');
        ...
        getCurrentQuarter: function () {
            ...
            return ayma.getQuarter(currentDate.getFullYear(), currentDate.getMonth());
        },
