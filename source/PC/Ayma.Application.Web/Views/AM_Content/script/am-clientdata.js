...
(function ($, ayma) {
    ...
    clientDataFn.modules = {
        ...
        init: function () {
            ...
            ayma.httpAsyncGet($.rootUrl + '/AM_SystemModule/Module/GetModuleList', function (res) {
    ...
    clientDataFn.userinfo = {
        ...
        init: function () {
            ...
            ayma.httpAsyncGet($.rootUrl + '/Login/GetUserInfo', function (res) {
                if (res.code == ayma.httpCode.success) {
    ...
    clientAsyncData.company = {
        ...
        init: function () {
            if (clientAsyncData.company.states == loadSate.no) {
                ...
                ayma.httpAsync('GET', top.$.rootUrl + '/AM_OrganizationModule/Company/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.department = {
        ...
        init: function () {
            if (clientAsyncData.department.states == loadSate.no) {
                ...
                ayma.httpAsync('GET', top.$.rootUrl + '/AM_OrganizationModule/Department/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.user = {
        ...
        init: function () {
            if (clientAsyncData.user.states == loadSate.no) {
                ...
                ayma.httpAsync('GET', top.$.rootUrl + '/AM_OrganizationModule/User/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.dataItem = {
        ...
        init: function () {
            if (clientAsyncData.dataItem.states == loadSate.no) {
                ...
                ayma.httpAsync('GET', top.$.rootUrl + '/AM_SystemModule/DataItem/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.db = {
        ...
        init: function () {
            if (clientAsyncData.db.states == loadSate.no) {
                ...
                ayma.httpAsync('GET', top.$.rootUrl + '/AM_SystemModule/DatabaseLink/GetMap', { ver: ver }, function (data) {
                    if (!data) {
    ...
    clientAsyncData.sourceData = {
        ...
        load: function (code) {
            ...
            ayma.httpAsync('GET', top.$.rootUrl + '/AM_SystemModule/DataSource/GetMap', { code: code, ver: ver }, function (data) {
                if (!data) {
    ...
    clientAsyncData.custmerData = {
        ...
        load: function (url) {
            ayma.httpAsync('GET', top.$.rootUrl + url, {}, function (data) {
                if (!!data) {
                    clientData[url] = data;
                }
