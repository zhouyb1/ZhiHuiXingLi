...
(function ($, ayma) {
    ...
    $.FormComponents = {
        label: {//文本标题
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="label" ><i  class="fa fa-font"></i>标 题</div>');
                return $html;
            },
            ...
            property: function ($component) {
                ...
                var $html = $(".am-custmerform-designer-layout-right .mCSB_container");
                var _html = '';
                _html += '<div class="am-component-title">组件标题</div>';
                _html += '<div class="am-component-control"><input id="am_component_title" type="text" class="form-control" placeholder="必填项"/></div>';
                _html += '<div class="am-component-control"><div id="am_component_verify"></div></div>';
                _html += '<div class="am-component-title">所占行比例</div>';
                _html += '<div class="am-component-control"><div id="am_component_proportion"></div></div>';
                $html.html(_html);

                // 标题设置
                $html.find('#am_component_title').val(dfop.title);
                $html.find('#am_component_title').keyup(function (e) {
                    var value = $(this).val();
                    dfop.title = value;
                    $component.find('.am-compont-title span').text(value);
                });
                // 所在行占比
                $('#am_component_proportion').select({
                    data: [
                        {
                            id: '1', text: '1'
                        },
                ...
                $('#am_component_proportion').selectSet(dfop.proportion);
            },
            renderTable: function (compont, $row) {
                $row.find('.am-form-item-title').remove();
        ...
        html: {//文本标题
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="html" ><i  class="fa fa-file-o"></i>富文本</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
            ...
            property: function ($component) {
                ...
                var $html = $(".am-custmerform-designer-layout-right .mCSB_container");
                var _html = '';
                _html += '<div class="am-component-title">文本内容</div>';
                _html += '<div class="am-component-control"><textarea id="am_component_title" type="text" style="height:300px;" class="form-control" placeholder="必填项"/></div>';
                _html += '<div class="am-component-control"><div id="am_component_verify"></div></div>';
                _html += '<div class="am-component-title">所占行比例</div>';
                _html += '<div class="am-component-control"><div id="am_component_proportion"></div></div>';
                $html.html(_html);
                ...
                // 标题设置
                $html.find('#am_component_title').val(htmlDecode(dfop.title));
                $html.find('#am_component_title').keyup(function (e) {
                    var value = $(this).val();
        ...
        text: {//文本框
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="text" ><i  class="fa fa-italic"></i>文本框</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
            ...
            property: function ($component) {
                ...
                var _html = '';
                _html += '<div class="am-component-title">是否隐藏</div>';
                _html += '<div class="am-component-control"><div id="am_component_isHide"></div></div>';
                _html += '<div class="am-component-title">默认值<i title="仅在添加数据时默认填入" class="help fa fa-question-circle"></i></div>';
                _html += '<div class="am-component-control"><input id="am_component_dfvalue" type="text" class="form-control" placeholder="无则不填"/></div>';

                $html.append(_html);
                $('#am_component_isHide').select({
                    placeholder: false,
                ...
                $('#am_component_isHide').selectSet(dfop.isHide);

                $html.find('#am_component_dfvalue').val(dfop.dfvalue);
                $html.find('#am_component_dfvalue').keyup(function (e) {
                    var value = $(this).val();
                    dfop.dfvalue = value;
                });
            },
        ...
        textarea: {//文本区
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="textarea" ><i class="fa fa-align-justify"></i>文本区</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
            ...
            property: function ($component) {
                ...
                var _html = '';
                _html += '<div class="am-component-title">区域高度</div>';
                _html += '<div class="am-component-control"><input id="am_component_height" type="text" class="form-control" /></div>';
                _html += '<div class="am-component-title">默认值<i title="仅在添加数据时默认填入" class="help fa fa-question-circle"></i></div>';
                _html += '<div class="am-component-control"><input id="am_component_dfvalue" type="text" class="form-control" placeholder="无则不填"/></div>';

                $html.append(_html);

                $html.find('#am_component_height').val(dfop.height);
                $html.find('#am_component_height').keyup(function (e) {
                    var value = $(this).val();
                    dfop.height = value;
                });
        ...
        texteditor: {//编辑器
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="texteditor" ><i class="fa fa-edit"></i>编辑器</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
        ...
        radio: {//单选框
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="radio" ><i class="fa fa-circle-thin"></i>单选框</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
            ...
            property: function ($component) {
                ...
                var _html = '';
                _html += '<div class="am-component-title">数据来源</div>';
                _html += '<div class="am-component-control"><div id="am_component_dataSource"></div></div>';
                _html += '<div class="am-component-title">数据选项</div>';
                _html += '<div class="am-component-control" id="am_component_dataItemCode1"><div id="am_component_dataItemCode"></div></div>';
                _html += '<div class="am-component-control" id="am_component_dataSourceId1" style="display:none;" ><div id="am_component_dataSourceId">dasd</div></div>';
                _html += '<div class="am-component-title">默认值<i title="仅在添加数据时默认填入" class="help fa fa-question-circle"></i></div>';
                _html += '<div class="am-component-control"><div id="am_component_dfvalue"></div></div>';
        ...
        checkbox: {//多选框
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="checkbox" ><i class="fa fa-square-o"></i>多选框</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
        ...
        select: {//下拉框
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="select" ><i class="fa fa-caret-square-o-right"></i>下拉框</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
            ...
            property: function ($component) {
                ...
                _html += '<div class="am-component-title">默认值<i title="仅在添加数据时默认填入" class="help fa fa-question-circle"></i></div>';
                _html += '<div class="am-component-control"><div id="am_component_dfvalue"></div></div>';
                _html += '<div class="am-component-title">下拉高度</div>';
                _html += '<div class="am-component-control"><input id="am_component_height" type="text" class="form-control" /></div>';
            ...
            renderTable: function (compont, $row) {//使用表单的时候渲染成table
                ...
                /*获取数据字典或者数据源数据*/
                if (compont.dataSource == '0') {
                    $compont.DataItemSelect({
                        allowSearch: true,
                        maxHeight: compont.height,
                        code: compont.itemCode
                    }).selectSet(compont.dfvalue);
                }
                else {
                    var vlist = compont.dataSourceId.split(',');


                    $compont.DataSourceSelect({
                        allowSearch: true,
                        maxHeight: compont.height,
                        code: vlist[0],
                        value: vlist[2],
        ...
        datetime: {//日期框
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="datetime" ><i class="fa fa-calendar"></i>日期框</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
            ...
            property: function ($component) {
                ...
                var $html = setComponentPropertyHtml($component, verifyDatalist2);
                var _html = '';
                _html += '<div class="am-component-title">日期格式</div>';
                _html += '<div class="am-component-control"><div id="am_component_dateformat"></div></div>';
                _html += '<div class="am-component-title">默认值<i title="仅在添加数据时默认填入" class="help fa fa-question-circle"></i></div>';
                _html += '<div class="am-component-control"><div id="am_component_dfvalue"></div></div>';

                $html.append(_html);
                $('#am_component_dateformat').select({
                ...
                }).selectSet(dfop.dateformat);
                $('#am_component_dfvalue').select({
            ...
            renderTable: function (compont, $row) {//使用表单的时候渲染成table
                ...
                datedefault = ayma.formatDate(datedefault, dateformat.replace(/H/g, 'h'));
                var $compont = $('<input value="' + datedefault + '" id="' + compont.id + '"    " onClick="WdatePicker({dateFmt:\'' + dateformat + '\',qsEnabled:false,isShowClear:false,isShowOK:false,isShowToday:false,onpicked:function(){$(\'#' + compont.id + '\').trigger(\'change\');}})"  type="text" class="form-control am-input-wdatepicker" />');
                $row.append($compont);
                return $compont;
            }
        },
        datetimerange: {
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="datetimerange" ><i class="fa fa-calendar"></i>日期区间</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
            ...
            property: function ($component) {
                ...
                var $html = setComponentPropertyHtml($component, verifyDatalist2);
                var _html = '';
                _html += '<div class="am-component-title">开始日期</div>';
                _html += '<div class="am-component-control"><div id="am_component_startTime"></div></div>';
                _html += '<div class="am-component-title">结束日期</div>';
                _html += '<div class="am-component-control"><div id="am_component_endTime"></div></div>';
                ...
                $parent.find('.am-compont-item').each(function () {
                ...
                }).selectSet(dfop.startTime);
                // 结束日期
                $('#am_component_endTime').select({
                    data: datatimes,
                    value: 'id',
                    text: 'text',
                    select: function (item) {
                ...
                function register() {
                    if ($('#' + compont.startTime).length > 0 && $('#' + compont.endTime).length > 0) {
                        $('#' + compont.startTime).on('change', function () {
                            ...
                            if (!!st && !!et) {
                                var diff = ayma.parseDate(st).DateDiff('d', et) + 1;
                                $compont.val(diff);
                            }
                        });
        ...
        encode: {//单据编码
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="encode" ><i class="fa fa-barcode"></i>编 码</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
            ...
            property: function ($component) {
                ...
                var $html = setComponentPropertyHtml($component);
                var _html = '';
                _html += '<div class="am-component-title">单据规则</div>';
                _html += '<div class="am-component-control"><div id="am_component_rulecode"></div></div>';

                $html.append(_html);

                $('#am_component_rulecode').select({
                    value: 'F_EnCode',
                    text: 'F_FullName',
                    title: 'F_FullName',
                    allowSearch: true,
                ...
                if (!!ruleCode) {
                    $('#am_component_rulecode').selectRefresh({
                        data: ruleCode
                    });
                }
                else {
                    ayma.httpAsync('GET', top.$.rootUrl + '/AM_SystemModule/CodeRule/GetList', {}, function (data) {
                        ruleCode = data;
                        $('#am_component_rulecode').selectRefresh({
                            data: ruleCode
                        });
            ...
            renderTable: function (compont, $row) {//使用表单的时候渲染成table
                ...
                ayma.httpAsync('GET', top.$.rootUrl + '/AM_SystemModule/CodeRule/GetEnCode', { code: compont.rulecode }, function (data) {
                    if (!$compont.val()) {
                        $compont.val(data);
                    }
                });
        ...
        organize: {//单位组织
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="organize" ><i  class="fa fa-coffee"></i>单位组织</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
            ...
            property: function ($component) {
                ...
                _html += '<div class="am-component-title">下拉高度</div>';
                _html += '<div class="am-component-control"><input id="am_component_height" type="text" class="form-control" /></div>';
                _html += '<div class="am-component-title">类型选择</div>';
                _html += '<div class="am-component-control"><div id="am_component_dataType"></div></div>';

                _html += '<div class="am-component-title lrrelation">单位组织控件级联-上一级</div>';
                _html += '<div class="am-component-control lrrelation"><div id="am_component_relation"></div></div>';
                ...
                }).selectSet(dfop.relation);
                /*类型选择*/
                $('#am_component_dataType').select({
                    ...
                    select: function (item) {
                        ...
                        switch (dfop.dataType) {
                            case "user"://用户
                                ...
                                $('#am_component_relation').selectRefresh({
                                    data: tmpData
                                });
                                $('.lrrelation').show();
                                break;
            ...
            renderTable: function (compont, $row) {
                ...
                switch (compont.dataType) {
                    ...
                    case "department"://部门
                        ...
                        break;
                    case "company"://公司
                        $compont.CompanySelect({ maxHeight: compont.height });
                        break;
                }
                return $compont;
            },
        ...
        currentInfo: {//固定信息
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="currentInfo" ><i  class="fa fa-book"></i>当前信息</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
            ...
            renderTable: function (compont, $row) {
                var $compont = $('<input id="' + compont.id + '" readonly type="text"  class="form-control am-currentInfo am-currentInfo-' + compont.dataType + '" />');
                ...
                switch (compont.dataType)
                {
                    ...
                    case 'user':
                        ...
                        break;
                    case 'time':
                        $compont[0].lrvalue = ayma.formatDate(new Date(), 'yyyy-MM-dd hh:mm:ss');
                        $compont.val($compont[0].lrvalue);
                        break;
                    case 'guid':
                        $compont[0].lrvalue = ayma.newGuid();
                        $compont.val($compont[0].lrvalue);
                        break;
                }
                if (compont.isHide == '1') {
        ...
        guid: {//固定信息
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="guid" ><i  class="fa fa-info"></i>GUID</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
            ...
            renderTable: function (compont, $row) {
                var $compont = $('<input id="' + compont.id + '" readonly type="text"  class="form-control am-currentInfo am-currentInfo-guid" />');
                $compont[0].lrvalue = ayma.newGuid();
                $compont.val($compont[0].lrvalue);
                $row.hide();
                $row.append($compont);
        ...
        upload: {//附件框
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="upload" ><i class="fa fa-paperclip"></i>附件上传</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
        ...
        girdtable: {
            init: function () {
                var $html = $('<div class="am-custmerform-component" data-type="girdtable" ><i class="fa fa-table"></i>编辑表格</div>');
                return $html;
            },
            render: function ($component) {
                $component[0].dfop = $component[0].dfop || {
            ...
            property: function ($component) {
                ...
                var $html = $(".am-custmerform-designer-layout-right .mCSB_container");
                var _html = '<div class="am-component-title">绑定表</div>';
                _html += '<div class="am-component-control"><div id="am_component_table"></div></div>';
                _html += '<div class="am-component-title">字段验证</div>';
                _html += '<div class="am-component-control"><div id="am_component_verify"></div></div>';
                _html += '<div class="am-component-title">所占行比例</div>';
                _html += '<div class="am-component-control"><div id="am_component_proportion"></div></div>';
                _html += '<div class="am-component-title">最小高度</div>';
                _html += '<div class="am-component-control"><input id="am_component_minheight" type="text" class="form-control" placeholder="必填项"/></div>';

                _html += '<div class="am-component-title">预加载数据库</div>';
                _html += '<div class="am-component-control"><div id="am_component_ydb"></div></div>';
                _html += '<div class="am-component-title">预加载数据表</div>';
                _html += '<div class="am-component-control"><div id="am_component_ytable"></div></div>';

                _html += '<div class="am-component-control" style="text-align: center;padding-top: 10px;" ><a id="am_fieldsData_set" class="btn btn-primary btn-block">设置表格字段</a></div>';

                $html.html(_html);
                $('#am_component_table').select({
                ...
                if (!!designerDfop.dbTable && designerDfop.dbTable.length > 0) {
                    $('#am_component_table').selectSet(dfop.table || designerDfop.dbTable[0].name);
                }
                // 标题设置
                $html.find('#am_component_minheight').val(dfop.minheight);
                $html.find('#am_component_minheight').keyup(function (e) {
                    var value = $(this).val();
                    dfop.minheight = value;
                });
                // 字段验证
                $('#am_component_verify').select({
                ...
                $('#am_component_verify').selectSet(dfop.verify);
                // 所在行占比
                $('#am_component_proportion').select({
                    data: [
                        {
                ...
                $('#am_component_proportion').selectSet(dfop.proportion);
                // 编辑表格字段
                $('#am_fieldsData_set').on('click', function () {
                    top.formGridSetting = {
                    ...
                    ayma.layerForm({
                        ...
                        title: '编辑表格选项',
                        url: top.$.rootUrl + '/AM_FormModule/Custmerform/SetFieldIndex?keyValue=formGridSetting',
                        width: 700,
                        height: 500,
                        maxmin: true,
                        btn: null,
                            ...
                            //$.CustmerFormDesigner.renderTabs($self);
                        }
                    });
                });
                ...
                }).selectSet(dfop.preloadTable);
                // 数据库表选择
                $('#am_component_ydb').select({
                    ...
                    select: function (item) {
                        if (item.hasChildren || item.id == -1) {
                            dfop.preloadDb = '';
                            $('#am_component_ytable').selectRefresh({
                                url: '',
                                data: [],
                            });
                        }
                ...
                }).selectSet(dfop.preloadDb);
            },
            renderTable: function (compont, $row) {
                $row.find('.am-form-item-title').remove();
                $row.addClass('am-form-item-grid');
                var $compont = $('<div id="' + compont.id + '"></div>');
                $row.append($compont);
                compont.hideData = [];
                ...
                if (!!compont.preloadDb && !!compont.preloadTable) {
                    ...
                    ayma.httpAsync('GET', top.$.rootUrl + '/AM_SystemModule/DatabaseTable/GetTableDataAllList', { databaseLinkId: compont.preloadDb, tableName: compont.preloadTable }, function (data) {
    ...
    function getComponentRowHtml(data) {
        var _html = '<div class="am-compont-title"><span>' + data.name + '</span><div class="am-compont-remove"><i  title="移除组件" class="del fa fa-close"></i></div></div><div class="am-compont-value">' + data.text + '</div>';
        return _html;
    };
    // 设置组件公共属性设置html
    function setComponentPropertyHtml($component, verifyData) {
        ...
        var $html = $(".am-custmerform-designer-layout-right .mCSB_container");
        var _html = '';
        _html += '<div class="am-component-title">绑定表</div>';
        _html += '<div class="am-component-control"><div id="am_component_table"></div></div>';
        _html += '<div class="am-component-title">绑定字段</div>';
        _html += '<div class="am-component-control"><div id="am_component_field"></div></div>';
        _html += '<div class="am-component-title">组件标题</div>';
        _html += '<div class="am-component-control"><input id="am_component_title" type="text" class="form-control" placeholder="必填项"/></div>';
        if (!!verifyData) {
            _html += '<div class="am-component-title">字段验证</div>';
            ...
            select: function (item) {
                if (!!item) {
                    ...
                    if (!!fieldMap[designerDfop.dbId + item.name]) {
                        $('#am_component_field').selectRefresh({
                            data: fieldMap[designerDfop.dbId + item.name]
                        });
                    }
                    else {
                        ayma.httpAsync('GET', top.$.rootUrl + '/AM_SystemModule/DatabaseTable/GetFieldList', { databaseLinkId: designerDfop.dbId, tableName: item.name }, function (data) {
        ...
        $('#am_component_field').selectSet(dfop.field);
        // 标题设置
        $html.find('#am_component_title').val(dfop.title);
        $html.find('#am_component_title').keyup(function (e) {
            var value = $(this).val();
    ...
    function setDatasource(dfop) {
        ...
        $('#am_component_dataItemCode').select({
            allowSearch: true,
            maxHeight: 150,
                ...
                if (!!item) {
                    ...
                    ayma.clientdata.getAllAsync('dataItem', {
                        ...
                        callback: function (dataes) {
                            ...
                            $('#am_component_dfvalue').selectRefresh({
                                value: "id",
                                text: "text",
                                title: "title",
                                data: list,
                    ...
                    dfop.dataSourceId = '';
                    dfop.itemCode = '';
                    $('#am_component_dfvalue').selectRefresh({ url: '', data: [] });
                }
            }
        });

        $('#am_component_dataSourceId').formselect({
            placeholder: '请选择数据源项',
        ...
        if (dfop.dataSource == "0") {
            $('#am_component_dataItemCode').selectSet(dfop.dataSourceId);
        }
        else {
            $('#am_component_dataSourceId').formselectSet(dfop.dataSourceId);
        }

        $('#am_component_dataSource').select({
            ...
            select: function (item) {
                ...
                if (dfop.dataSource == '0') {
                    $('#am_component_dataSourceId1').hide();
                    $('#am_component_dataItemCode1').show();
                }
                else {
                    $('#am_component_dataItemCode1').hide();
                    $('#am_component_dataSourceId1').show();
                }
            }
        }).selectSet(dfop.dataSource);
    };
    // 转化成树形数据
    function toGirdheadData(data, hideData) {
        ...
        for (var i = 0, l = data.length; i < l; i++) {
            ...
            var isAdd = true;
            //表头信息设置
            var point = { id: item.id, label: item.name, name: item.field || ayma.newGuid(), width: parseInt(item.width), align: item.align || "left", editType: item.type };
