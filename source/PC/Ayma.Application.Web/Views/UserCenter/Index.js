        ...
        initleft: function () {
            $('#am_left_list li').on('click', function () {
                ...
                if (!$this.hasClass('active')) {
                    ...
                    $('.am-layout-wrap-item').removeClass('active');
                    $('#am_layout_item' + _type).addClass('active');
                }
            });
        },
        initData: function () {
            ayma.httpAsyncGet(top.$.rootUrl + '/UserCenter/GetUserInfo', function (res) {
                if (res.code == 200) {
