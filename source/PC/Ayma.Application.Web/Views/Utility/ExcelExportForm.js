...
var bootstrap = function ($, ayma) {
    ...
    var page = {
        init: function () {
            var columnModel = ayma.frameTab.currentIframe().$('#' + gridId).jfGridGet('settingInfo').headData;
    ...
    acceptClick = function (callBack) {
        ...
        var columnJson = JSON.stringify(ayma.frameTab.currentIframe().$('#' + gridId).jfGridGet('settingInfo').headData);
        var rowJson = JSON.stringify(ayma.frameTab.currentIframe().$('#' + gridId).jfGridGet('showData'));
        ayma.download({
            method: "POST",
