...
var bootstrap = function ($, ayma) {
    ...
    var meuns = {
        ...
        load: function () {
            ...
            for (var i = 0, l = modules.length; i < l; i++) {
                ...
                if (item.F_IsMenu == 1) {
                    ...
                    menuItemHtml += '<span class="am-menu-item-arrow"><i class="fa fa-angle-left"></i></span></a>';
        ...
        bind: function () {
            ...
            $('#am_frame_menu a').hover(function () {
                if ($('body').hasClass('am-menu-closed')) {
                    var id = $(this).attr('id');
            ...
            $('.am-frame-personCenter .dropdown-toggle').hover(function () {
                if ($('body').hasClass('am-menu-closed')) {
                    var text = $(this).text();
                    layer.tips(text, $(this));
                }
                ...
                switch (_module.F_Target) {
                    ...
                    case 'expand':// 打开子菜单
                        ...
                        if ($ul.is(':visible')) {
                            ...
                            if ($ul.hasClass('am-second-menu-list')) {
                                $('#am_frame_menu .am-second-menu-list').slideUp(300, function () {
