...
var bootstrap = function ($, ayma) {
    ...
    var meuns = {
        ...
        bind: function () {
            ...
            $("#am_frame_menu .am-first-menu-list > li").hover(function (e) {// 一级菜单选中的时候判断二级菜单的位置
                $('#am_frame_menu').width(4000);
                var $secondMenu = $(this).find('.am-second-menu-list');
                ...
                $('#am_frame_menu').width(80);
            });

            $("#am_frame_menu .am-second-menu-list > li.am-meun-had").hover(function (e) {// 二级菜单选中的时候判断三级菜单的位置
                var $ul = $(this).find('.am-three-menu-list');
                $ul.css('top', '-9px');
