...
namespace Ayma.Util.Operat
{
    ...
    public class OperatorHelper
    {
        ...
        private string cacheKeyOperator = "ayma_adms_operator_";// +登录者token
        private string cacheKeyToken = "ayma_adms_token_";// +登录者token
        private string cacheKeyError = "ayma_adms_error_";// + Mark
        /// <summary>
        /// 秘钥
        /// </summary>
