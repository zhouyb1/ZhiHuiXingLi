...
namespace Ayma.DataBase.Oracle
{
    /// <summary>
    /// 创建人：Ayma
    /// 日 期：2017.03.04
    ...
    public class DatabaseContext : DbContext, IDisposable, IObjectContextAdapter
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            string assembleFileName = Assembly.GetExecutingAssembly().CodeBase.Replace("Ayma.DataBase.Oracle.DLL", "Ayma.Application.Mapping.DLL").Replace("file:///", "");
