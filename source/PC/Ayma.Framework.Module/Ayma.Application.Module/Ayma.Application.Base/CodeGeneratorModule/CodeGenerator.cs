...
using Ayma.Application.BaseModule.CodeGeneratorModule;
using Ayma.Util;
using System;
...
namespace Ayma.Application.Base.CodeGeneratorModule
{
    /// <summary>
    /// 创建人：Ayma
    /// 日 期：2017.04.17
    ...
    public class CodeGenerator
    {
        ...
        public string EntityCreate(CodeBaseConfigModel baseConfigModel,string tableName)
        {
            ...
            try
            {
                ...
                sb.Append("    public partial class " + tableName + "Entity \r\n");
                sb.Append("    {\r\n");
        ...
        public string MappingCreate(CodeBaseConfigModel baseConfigModel, string tableName)
        {
            try
            {
                ...
                sb.Append("namespace  Ayma.Application.Mapping\r\n");
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseConfigModel));
                sb.Append("    public partial class " + tableName + "Map : EntityTypeConfiguration<" + tableName + "Entity>\r\n");
                sb.Append("    {\r\n");
        ...
        public string ServiceCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("using Ayma.DataBase.Repository;\r\n");
                sb.Append("using Ayma.Util;\r\n");
                sb.Append("using System;\r\n");
                ...
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseConfigModel));
                sb.Append("    public partial class " + baseConfigModel.name + "Service : RepositoryFactory\r\n");
                sb.Append("    {\r\n");
                ...
                //sb.Append("        /// <param name=\"keyValue\">主键</param>\r\n");
                //sb.Append("        /// <returns></returns>\r\n");
                //sb.Append("        public void VirtualDelete(string keyValue)\r\n");
                //content = "";
                //content += "                " + baseConfigModel.tableName + "Entity entity = new " + baseConfigModel.tableName + "Entity()\r\n";
                //content += "                {\r\n";
                //content += "                    " + pk + " = keyValue,\r\n";
                //content += "                    F_DeleteMark = 1\r\n";
                //content += "                };\r\n";
                //content += "                this.BaseRepository().Update(entity);\r\n";
                //sb.Append(getServiceTry(content));
        ...
        public string ServiceCreate(string databaseLinkId, List<DbTableModel> dbTableList, Dictionary<string, CompontModel> compontMap, QueryModel queryData, ColModel colData, BaseModel baseInfo)
        {
            try
            {
                ...
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseInfo));
                sb.Append("    public partial class " + baseInfo.name + "Service : RepositoryFactory\r\n");
                sb.Append("    {\r\n");
                #endregion
        ...
        public string IBllCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                //sb.Append("        /// <param name=\"keyValue\">主键</param>\r\n");
                //sb.Append("        /// <returns></returns>\r\n");
                //sb.Append("        void VirtualDelete(string keyValue);\r\n");
        ...
        public string BllCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseConfigModel));
                sb.Append("    public partial class " + baseConfigModel.name + "BLL : " + baseConfigModel.name + "IBLL\r\n");
                sb.Append("    {\r\n");
                ...
                //sb.Append("        public void VirtualDelete(string keyValue)\r\n");
                //content = "";
                //content += "                " + Str.FirstLower(baseConfigModel.name) + "Service.VirtualDelete(keyValue);\r\n";
                //sb.Append(getBllTry(content));
        ...
        public string BllCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CompontModel> compontMap, ColModel colData)
        {
            try
            {
                ...
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseInfo));
                sb.Append("    public partial class " + baseInfo.name + "BLL : " + baseInfo.name + "IBLL\r\n");
                sb.Append("    {\r\n");
                ...
                //sb.Append("        public void VirtualDelete(string keyValue)\r\n");
                //content = "";
                //content += "                " + Str.FirstLower(baseInfo.name) + "Service.VirtualDelete(keyValue);\r\n";
                //sb.Append(getBllTry(content));
        ...
        public string ControllerCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("namespace Ayma.Application.Web.Areas." + baseConfigModel.area + ".Controllers\r\n");
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseConfigModel));
                sb.Append("    public partial class " + baseConfigModel.name + "Controller : MvcControllerBase\r\n");
                sb.Append("    {\r\n");
        ...
        public string ControllerCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CompontModel> compontMap, ColModel colData)
        {
            try
            {
                ...
                sb.Append("namespace Ayma.Application.Web.Areas." + baseInfo.outputArea + ".Controllers\r\n");
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseInfo));
                sb.Append("    public partial class " + baseInfo.name + "Controller : MvcControllerBase\r\n");
                sb.Append("    {\r\n");
        ...
        public string IndexCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("<div class=\"am-layout am-layout-left-center\" id=\"am_layout\">\r\n");
                sb.Append("    <div class=\"am-layout-left\">\r\n");
                sb.Append("        <div class=\"am-layout-wrap\">\r\n");
                sb.Append("            <div class=\"am-layout-title\">树形目录</div>\r\n");
                sb.Append("            <div id=\"tree\" class=\"am-layout-body\"></div>\r\n");
                sb.Append("        </div>\r\n");
                sb.Append("    </div>\r\n");
                sb.Append("    <div class=\"am-layout-center\">\r\n");
                sb.Append("        <div class=\"am-layout-wrap\">\r\n");
                sb.Append("            <div class=\"am-layout-title\">标题</div>\r\n");
                sb.Append("            <div class=\"am-layout-tool\">\r\n");
                sb.Append("                <div class=\"am-layout-tool-left\">\r\n");
                sb.Append("                    <div class=\"am-layout-tool-item\">\r\n");
                ...
                sb.Append("                    </div>\r\n");
                sb.Append("                </div>\r\n");
                sb.Append("                <div class=\"am-layout-tool-right\">\r\n");
                sb.Append("                    <div class=\" btn-group btn-group-sm\">\r\n");
                sb.Append("                        <a id=\"am_refresh\" class=\"btn btn-default\"><i class=\"fa fa-refresh\"></i></a>\r\n");
                sb.Append("                    </div>\r\n");
                sb.Append("                    <div class=\" btn-group btn-group-sm\" ayma-authorize=\"yes\">\r\n");
                sb.Append("                        <a id=\"am_add\"   class=\"btn btn-default\"><i class=\"fa fa-plus\"></i>&nbsp;新增</a>\r\n");
                sb.Append("                        <a id=\"am_edit\"  class=\"btn btn-default\"><i class=\"fa fa-pencil-square-o\"></i>&nbsp;编辑</a>\r\n");
                sb.Append("                        <a id=\"am_delete\" class=\"btn btn-default\"><i class=\"fa fa-trash-o\"></i>&nbsp;删除</a>\r\n");
                sb.Append("                    </div>\r\n");
                sb.Append("                </div>\r\n");
                sb.Append("            </div>\r\n");
                sb.Append("            <div class=\"am-layout-body\" id=\"girdtable\"></div>\r\n");
                sb.Append("        </div>\r\n");
                sb.Append("    </div>\r\n");
                sb.Append("</div>\r\n");
        ...
        public string IndexCreate(BaseModel baseInfo, Dictionary<string, CompontModel> compontMap, QueryModel queryData)
        {
            try
            {
                ...
                sb.Append("<div class=\"am-layout\" >\r\n");
                sb.Append("    <div class=\"am-layout-center\">\r\n");
                sb.Append("        <div class=\"am-layout-wrap am-layout-wrap-notitle\">\r\n");
                sb.Append("            <div class=\"am-layout-tool\">\r\n");
                sb.Append("                <div class=\"am-layout-tool-left\">\r\n");
                ...
                if (queryData.fields.Count > 0)
                {
                    ...
                    sb.Append("                            <div class=\"am-query-formcontent\">\r\n");
                    foreach (var item in queryData.fields)
                    {
                        sb.Append("                                <div class=\"col-xs-" + (12 / Convert.ToInt32(item.portion)) + " am-form-item\">\r\n");
                        sb.Append("                                    <div class=\"am-form-item-title\">" + item.fieldName + "</div>\r\n");
                        ...
                        {
                            sb.Append("                                    <input id=\"" + item.fieldId + "\" type=\"text\" class=\"form-control am-input-wdatepicker\" onfocus=\"WdatePicker()\" />\r\n");
                        }
        ...
        public string IndexJSCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("var bootstrap = function ($, ayma) {\r\n");
                ...
                sb.Append("            });\r\n");
                sb.Append("            // 刷新\r\n");
                sb.Append("            $('#am_refresh').on('click', function () {\r\n");
                sb.Append("                location.reload();\r\n");
                sb.Append("            });\r\n");
                sb.Append("            // 新增\r\n");
                sb.Append("            $('#am_add').on('click', function () {\r\n");
                sb.Append("                selectedRow = null;\r\n");
                sb.Append("                ayma.layerForm({\r\n");
                sb.Append("                    id: 'form',\r\n");
                sb.Append("                    title: '新增',\r\n");
                ...
                sb.Append("            });\r\n");
                sb.Append("            // 删除\r\n");
                sb.Append("            $('#am_delete').on('click', function () {\r\n");
                sb.Append("                var keyValue = $('#girdtable').jfGridValue('" + pk + "');\r\n");
                sb.Append("                if (ayma.checkrow(keyValue)) {\r\n");
                sb.Append("                    ayma.layerConfirm('是否确认删除该项！', function (res) {\r\n");
                sb.Append("                        if (res) {\r\n");
                sb.Append("                            ayma.deleteForm(top.$.rootUrl + '/" + baseConfigModel.area + "/" + baseConfigModel.name + "/DeleteForm', { keyValue: keyValue}, function () {\r\n");
                sb.Append("                            });\r\n");
                sb.Append("                        }\r\n");
                sb.Append("                    });\r\n");
                sb.Append("                }\r\n");
                ...
                sb.Append("            $('#girdtable').AuthorizeJfGrid({\r\n");
        ...
        public string IndexJSCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, FormModel formData, Dictionary<string, CompontModel> compontMap, ColModel colData, QueryModel queryData)
        {
            try
            {
                ...
                {
                    sb.Append("            // 时间搜索框\r\n");
                    sb.Append("            $('#datesearch').amdate({\r\n");
                    sb.Append("                dfdata: [\r\n");
                    sb.Append("                    { name: '今天', begin: function () { return ayma.getDate('yyyy-MM-dd 00:00:00') }, end: function () { return ayma.getDate('yyyy-MM-dd 23:59:59') } },\r\n");
                    sb.Append("                    { name: '近7天', begin: function () { return ayma.getDate('yyyy-MM-dd 00:00:00', 'd', -6) }, end: function () { return ayma.getDate('yyyy-MM-dd 23:59:59') } },\r\n");
                    sb.Append("                    { name: '近1个月', begin: function () { return ayma.getDate('yyyy-MM-dd 00:00:00', 'm', -1) }, end: function () { return ayma.getDate('yyyy-MM-dd 23:59:59') } },\r\n");
                    sb.Append("                    { name: '近3个月', begin: function () { return ayma.getDate('yyyy-MM-dd 00:00:00', 'm', -3) }, end: function () { return ayma.getDate('yyyy-MM-dd 23:59:59') } }\r\n");
                    sb.Append("                ],\r\n");
                    sb.Append("                // 月\r\n");
                ...
                if (queryData.fields.Count > 0)
                {
                    sb.Append("            $('#multiple_condition_query').MultipleQuery(function (queryJson) {\r\n");
                    ...
                    foreach (var item in queryData.fields)
                    {
                        ...
                        if (compont.type == "select")
                        {
                            ...
                            {
                                sb.Append("            $('#" + compont.fieldId + "').DataItemSelect({ code: '" + compont.dataItemCode + "' });\r\n");
                            }
                            else
                            {
                                string[] vlist = compont.dataSourceId.Split(',');
                                sb.Append("            $('#" + compont.fieldId + "').DataSourceSelect({ code: '" + vlist[0] + "',value: '" + vlist[2] + "',text: '" + vlist[1] + "' });\r\n");
                            }
                        }
                        else if (compont.type == "radio" || compont.type == "checkbox")
                        {

                            sb.Append("            $('#" + compont.fieldId + "').RadioCheckbox({\r\n");
                ...
                sb.Append("                    ayma.layerConfirm('是否确认删除该项！', function (res) {\r\n");
                sb.Append("                        if (res) {\r\n");
                sb.Append("                            ayma.deleteForm(top.$.rootUrl + '/" + baseInfo.outputArea + "/" + baseInfo.name + "/DeleteForm', { keyValue: keyValue}, function () {\r\n");
                ...
                foreach (var col in colData.fields)
                {
                    ...
                    if (compont.type == "select" || compont.type == "radio" || compont.type == "checkbox")
                    {
                        ...
                        if (compont.dataSource == "0")
                        {
                            sb.Append("                             ayma.clientdata.getAsync('dataItem', {\r\n");
                            sb.Append("                                 key: value,\r\n");
                        ...
                        {
                            string[] vlist = compont.dataSourceId.Split(',');
                            sb.Append("                             ayma.clientdata.getAsync('custmerData', {\r\n");
                            sb.Append("                                 url: '/AM_SystemModule/DataSource/GetDataTable?code=' + '" + vlist[0] + "',\r\n");
                            sb.Append("                                 key: value,\r\n");
        ...
        public string WfIndexJSCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, FormModel formData, Dictionary<string, CompontModel> compontMap, ColModel colData, QueryModel queryData)
        {
            try
            {
                ...
                sb.Append("                        // 保存数据\r\n");
                sb.Append("                        if (res) {\r\n");
                sb.Append("                            processId = ayma.newGuid();\r\n");
                ...
                sb.Append("        {\r\n");
                sb.Append("            // 发起流程\r\n");
                sb.Append("            ayma.workflowapi.create({\r\n");
        ...
        private void CreateFormCompont(StringBuilder sb, List<CompontModel> componts)
        {
            foreach (var compont in componts)
            {
                ...
                {
                    sb.Append("    <div class=\"col-xs-12 am-form-item am-form-item-grid\" >\r\n");
                    sb.Append("        <div id=\"" + compont.tableName + "\"></div>\r\n");
                    sb.Append("    </div>\r\n");
                }
                else
                {
                    sb.Append("    <div class=\"col-xs-" + (12 / Convert.ToInt32(compont.proportion)) + " am-form-item\"  data-table=\"" + compont.tableName + "\" >\r\n");
                    sb.Append("        <div class=\"am-form-item-title\">" + compont.fieldName + (string.IsNullOrEmpty(compont.validator) ? "" : "<font face=\"宋体\">*</font>") + "</div>\r\n");
                    ...
                    switch (compont.type)
                    {
                        ...
                        case "textarea":
                            ...
                            break;
                        case "datetime":
                            sb.Append("        <input id=\"" + compont.fieldId + "\" type=\"text\" class=\"form-control am-input-wdatepicker\" onfocus=\"WdatePicker({ onpicked: function () { $('#" + compont.fieldId + "').trigger('change'); } })\"  " + strValid + " />\r\n");
                            break;
                        case "file":
                        case "select":
        ...
        public string FormCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                IEnumerable<DatabaseTableFieldModel> fieldList = databaseTableIBLL.GetTableFiledList(baseConfigModel.databaseLinkId, baseConfigModel.tableName);
                sb.Append("<div class=\"am-form-wrap\" id=\"form\">\r\n");
                foreach (var fileditem in fieldList)
                {
                    sb.Append("    <div class=\"col-xs-6 am-form-item\">\r\n");
                    sb.Append("        <div class=\"am-form-item-title\">" + fileditem.f_remark + "<font face=\"宋体\">*</font></div>\r\n");
        ...
        public string FormCreate(BaseModel baseInfo, FormModel formData, Dictionary<string, CompontModel> compontMap, bool haveEditGird)
        {
            try
            {
                ...
                {
                    sb.Append("<div class=\"am-form-tabs\" id=\"am_form_tabs\">\r\n");
                    ...
                    sb.Append("    </ul>\r\n</div>\r\n");
                    num = 1;
                    sb.Append("<div class=\"tab-content am-tab-content\" id=\"am_tab_content\">\r\n");
                    foreach (var tab in formData.tablist)
                    {
                        sb.Append("<div class=\"am-form-wrap tab-pane\" id=\"tab" + num + "\">\r\n");
        ...
        public string FormJsCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("var bootstrap = function ($, ayma) {\r\n");
                sb.Append("    \"use strict\";\r\n");
                sb.Append("    var selectedRow = ayma.frameTab.currentIframe().selectedRow;\r\n");
                sb.Append("    var page = {\r\n");
                sb.Append("        init: function () {\r\n");
                sb.Append("        },\r\n");
                sb.Append("        bind: function () {\r\n");
                ...
                sb.Append("                $('#form').SetFormData(selectedRow);\r\n");
                sb.Append("            }\r\n");
                sb.Append("        }\r\n");
                sb.Append("    };\r\n");
                sb.Append("    // 保存数据\r\n");
                sb.Append("    acceptClick = function (callBack) {\r\n");
                sb.Append("        if (!$('#form').Validform()) {\r\n");
                sb.Append("            return false;\r\n");
                sb.Append("        }\r\n");
                sb.Append("        var postData = $('#form').GetFormData();\r\n");
                sb.Append("        $.SaveForm(top.$.rootUrl + '/" + baseConfigModel.area + "/" + baseConfigModel.name + "/SaveForm?keyValue=' + keyValue, postData, function (res) {\r\n");
                sb.Append("            // 保存成功后才回调\r\n");
        ...
        public string FormJsCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, FormModel formData)
        {
            try
            {
                ...
                sb.Append("$('.am-form-wrap').mCustomScrollbar({");
                ...
                {
                    sb.Append("            $('#am_form_tabs').FormTab();\r\n");
                    sb.Append("            $('#am_form_tabs ul li').eq(0).trigger('click');\r\n");
                }
                    ...
                    foreach (var compont in tab.componts)
                    {
                        switch (compont.type)
                        {
                            case "gridtable":
                                    ...
                                    if (girdFiled.fixedInfoHide == "0")
                                    {
                                        ...
                                        switch (girdFiled.type)
                                        {
                                            ...
                                            case "select":
                                                ...
                                                {
                                                    sb.Append("                            url: top.$.rootUrl + '/AM_SystemModule/DataItem/GetDetailList',\r\n");
                                                    sb.Append("                            param: { itemCode: '" + girdFiled.dataItemCode + "' },\r\n");
                                                }
                                                else
                                                {
                                                    sb.Append("                            url: top.$.rootUrl + '/AM_SystemModule/DataSource/GetDataTable',\r\n");
                                ...
                                break;
                            case "file":
                                sb.Append("            $('#" + compont.fieldId + "').Uploader();\r\n");
                                break;
                            case "select":
                                if (compont.dataSource == "0")
                                {
                ...
                sb.Append("                $.SetForm(top.$.rootUrl + '/" + baseInfo.outputArea + "/" + baseInfo.name + "/GetFormData?keyValue=' + keyValue, function (data) {\r\n");
                ...
                sb.Append("                        }\r\n");
                sb.Append("                        else {\r\n");
                sb.Append("                            $('[data-table=\"' + id + '\"]').SetFormData(data[id]);\r\n");
                sb.Append("                        }\r\n");
                sb.Append("                    }\r\n");
                sb.Append("                });\r\n");
                sb.Append("            }\r\n");
                ...
                if (dbTableList.Count == 1)
                {
                    ...
                    sb.Append("            strEntity: JSON.stringify($('body').GetFormData())\r\n");
                    sb.Append("        };\r\n");
                }
                else
                {
                    ...
                    foreach (var table in dbTableList)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                sb.Append("        postData.strEntity = JSON.stringify($('[data-table=\"" + table.name + "\"]').GetFormData());\r\n");
                            }
                            else
                            {
                                sb.Append("        postData.str" + Str.FirstLower(table.name) + "Entity = JSON.stringify($('[data-table=\"" + table.name + "\"]').GetFormData());\r\n");
                            }
                        }
                    }
                }
                sb.Append("        $.SaveForm(top.$.rootUrl + '/" + baseInfo.outputArea + "/" + baseInfo.name + "/SaveForm?keyValue=' + keyValue, postData, function (res) {\r\n");
                sb.Append("            // 保存成功后才回调\r\n");
                sb.Append("            if (!!callBack) {\r\n");
                sb.Append("                callBack();\r\n");
                sb.Append("            }\r\n");
        ...
        public string WfFormJsCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, FormModel formData)
        {
            try
            {
                ...
                sb.Append("            $.SetForm(top.$.rootUrl + '/" + baseInfo.outputArea + "/" + baseInfo.name + "/GetFormDataByProcessId?processId=' + processId, function (data) {\r\n");
                sb.Append("                for (var id in data) {\r\n");
                sb.Append("                    if (!!data[id] && data[id].length > 0) {\r\n");
                ...
                if (dbTableList.Count == 1)
                {
                    ...
                    sb.Append("        var formData = $('body').GetFormData();\r\n");
                ...
                else
                {
                    ...
                    foreach (var table in dbTableList)
                    {
                        ...
                        else
                        {
                            if (string.IsNullOrEmpty(table.relationName))
                            {
                                sb.Append("        var formData = $('[data-table=\"" + table.name + "\"]').GetFormData();\r\n");
                                sb.Append("        if(!!processId){\r\n");
                                sb.Append("            formData." + mainPkey + " =processId;\r\n");
                                sb.Append("        }\r\n");
        ...
        public void CreateMapCodeFile(CodeBaseConfigModel codeBaseConfigModel, string tableName, string codeContent)
        {
            try
            {
                ...
                CreateCodeFile(codeBaseConfigModel.mappingDirectory + "\\" + backArea + tableName + "Map.cs", codeContent, codeBaseConfigModel.mappingDirectory + "\\Ayma.Application.Mapping.csproj", backArea + tableName + "Map.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateMapCodeFile(BaseModel baseInfo, string tableName, string codeContent)
        {
            ...
            {
                string backProject = ConfigurationManager.AppSettings["BackProject"].ToString();
                CreateCodeFile(baseInfo.mappingDirectory + "\\" + baseInfo.outputArea + "\\" + tableName + "Map.cs", codeContent, baseInfo.mappingDirectory + "\\Ayma.Application.Mapping.csproj", baseInfo.outputArea + "\\" + tableName + "Map.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateControllerCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Controllers\\" + codeBaseConfigModel.name + "Controller.cs", codeContent, codeBaseConfigModel.webDirectory + "\\Ayma.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Controllers\\" + codeBaseConfigModel.name + "Controller.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateControllerCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Controllers\\" + baseInfo.name + "Controller.cs", codeContent, baseInfo.webDirectory + "\\Ayma.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Controllers\\" + baseInfo.name + "Controller.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.cshtml", codeContent, codeBaseConfigModel.webDirectory + "\\Ayma.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.cshtml", codeContent, baseInfo.webDirectory + "\\Ayma.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexJSCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.js", codeContent, codeBaseConfigModel.webDirectory + "\\Ayma.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexJSCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.js", codeContent, baseInfo.webDirectory + "\\Ayma.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.cshtml", codeContent, codeBaseConfigModel.webDirectory + "\\Ayma.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.cshtml", codeContent, baseInfo.webDirectory + "\\Ayma.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormJSCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.js", codeContent, codeBaseConfigModel.webDirectory + "\\Ayma.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormJSCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.js", codeContent, baseInfo.webDirectory + "\\Ayma.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.js", true);
            }
            catch (Exception)
            {
                throw;
