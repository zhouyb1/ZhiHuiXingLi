...
namespace Ayma.Application.Base.SystemModule
{
    ...
    public class ModuleBLL : ModuleIBLL
    {
        ...
        private string cacheKey = "ayma_modules";
        private string cacheKeyBtn = "ayma_modules_Btn_";      // + 模块主键
        private string cacheKeyColumn = "ayma_modules_Column_";// + 模块主键
        #endregion
        ...
        public List<TreeModel> GetButtonCheckTree()
        {
            ...
            {
                TreeModel node = new TreeModel();
                node.id = module.F_ModuleId + "_ayma_moduleId";
                ...
                node.parentId = module.F_ParentId + "_ayma_moduleId";
                if (module.F_Target != "expand")
                {
                    ...
                    foreach (var button in buttonList)
                    {
                        ...
                        buttonNode.parentId = (button.F_ParentId == "0" ? button.F_ModuleId + "_ayma_moduleId" : button.F_ParentId);
            ...
            foreach (var module in modulelist)
            {
                ...
                if (module.F_Target != "expand")
                {
                    ...
                    foreach (var column in columnList)
                    {
                        ...
                        columnNode.parentId = column.F_ModuleId + "_ayma_moduleId";
        ...
        public void SaveEntity(string keyValue, ModuleEntity moduleEntity, List<ModuleButtonEntity> moduleButtonEntitys, List<ModuleColumnEntity> moduleColumnEntitys, string type = "0")
        {
            try
            {
                moduleService.SaveEntity(keyValue, moduleEntity, moduleButtonEntitys, moduleColumnEntitys, type);
                /*移除缓存信息*/
                cache.Remove(cacheKey, CacheId.module);
