...
namespace Ayma.Application.AppMagager
{
    /// <summary>
    /// 创建人：Ayma
    /// 日 期：2018.03.16
    ...
    public class FunctionSerivce: RepositoryFactory
    {
        ...
        public IEnumerable<FunctionEntity> GetPageList(Pagination pagination, string keyword, string type)
        {
            try
            {
                ...
                strSql.Append(sql);
                strSql.Append(" FROM AM_App_Function t WHERE 1=1");
                ...
                {
                    strSql.Append(" AND t.F_Type = @category ");
                }
        ...
        public IEnumerable<FunctionEntity> GetList()
        {
            try
            {
                ...
                strSql.Append("SELECT ");
                strSql.Append(sql);
                strSql.Append(" ,s.F_Scheme FROM AM_App_Function t LEFT JOIN AM_App_FnScheme s on  t.F_SchemeId = s.F_Id where t.F_EnabledMark = 1 ORDER BY F_SortCode ");
