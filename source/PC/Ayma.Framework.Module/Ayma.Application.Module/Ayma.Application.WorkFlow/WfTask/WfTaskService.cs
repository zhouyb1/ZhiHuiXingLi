            ...
            try
            {
                ...
                strSql.Append(@"SELECT
                                ...
                                (
                                    ...
                                    FROM
	                                    AM_WF_Task t WHERE t.F_IsFinished = 0 ");
                ...
                strSql.Append(@" ) GROUP BY
	                                t.F_ProcessId,
	                                t.F_NodeId,
	                                t.F_NodeName )a LEFT JOIN AM_WF_ProcessInstance p ON p.F_Id = a.F_ProcessId WHERE 1=1 AND (p.F_IsFinished = 0 OR a.F_TaskType = 3) AND p.F_EnabledMark = 1 ");
        ...
        public IEnumerable<WfProcessInstanceEntity> GetHasList(string userId, Pagination pagination, string queryJson)
        {
            try
            {
                ...
                strSql.Append(@"SELECT
                                ...
                                FROM
	                                AM_WF_Task t
                                LEFT JOIN AM_WF_ProcessInstance p ON t.F_ProcessId = p.F_Id
                                WHERE
