...
namespace Ayma.Application.TwoDevelopment.TwoDev
{
    ...
    /// 描 述：机场信息管理
    /// </summary>
    public partial class AirportMessageBLL : AirportMessageIBLL
    {
        ...
        public IEnumerable<T_AirfieldInfoEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return airportMessageService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
        ...
        public T_AirfieldInfoEntity GetT_AirfieldInfoEntity(string keyValue)
        {
            try
            {
                return airportMessageService.GetT_AirfieldInfoEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                airportMessageService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, T_AirfieldInfoEntity entity)
        {
            try
            {
                airportMessageService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
