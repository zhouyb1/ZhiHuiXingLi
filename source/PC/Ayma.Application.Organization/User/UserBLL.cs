...
namespace Ayma.Application.Organization
{
    ...
    public class UserBLL : UserIBLL
    {
        ...
        private string cacheKey = "ayma_adms_user_";       // +公司主键
        private string cacheKeyAccount = "ayma_adms_user_account_";// +用户账号（账号不允许改动）
        private string cacheKeyId = "ayma_adms_user_Id_";// +用户账号（账号不允许改动）
        #endregion
