    ...
    public class UserService : RepositoryFactory
    {
        ...
        public UserEntity GetEntityByAccount(string account)
        {
            try
            {
                ...
                strSql.Append(" FROM AM_Base_User t ");
        ...
        public IEnumerable<UserEntity> GetAllList()
        {
            try
            {
                ...
                strSql.Append("SELECT ");
                strSql.Append(fieldSql.Replace("t.F_Password,", "").Replace("t.F_Secretkey,", ""));
                strSql.Append(" FROM AM_Base_User t WHERE t.F_DeleteMark = 0  ORDER BY t.F_CompanyId,t.F_DepartmentId,t.F_RealName ");
        ...
        public DataTable GetExportList()
        {
            try
            {
                ...
                strSql.Append(@"SELECT u.F_Account
                                  ...
                                  ,u.F_CreateUserName
                              FROM AM_Base_User u
                              INNER JOIN AM_Base_Department d ON u.F_DepartmentId=d.F_DepartmentId
                              INNER JOIN AM_Base_Company o ON u.F_CompanyId=o.F_CompanyId WHERE u.F_DeleteMark = 0 ");
