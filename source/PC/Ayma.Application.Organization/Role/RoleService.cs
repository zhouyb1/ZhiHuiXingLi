    ...
    public class RoleService : RepositoryFactory
    {
        ...
        public IEnumerable<RoleEntity> GetList()
        {
            try
            {
                ...
                strSql.Append(" FROM AM_Base_Role t WHERE t.F_EnabledMark = 1 AND t.F_DeleteMark = 0 ORDER BY t.F_FullName ");
        ...
        public void VirtualDelete(string keyValue)
        {
            ...
            try
            {
                ...
                db.Update(entity);
                db.ExecuteBySql(" Delete  From AM_BASE_USERRELATION where F_OBJECTID = @keyValue  ", new { keyValue = keyValue });
